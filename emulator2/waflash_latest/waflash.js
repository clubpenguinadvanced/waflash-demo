        ...
        function(Module) {
            ...
            (function() {
                var loadPackage = function(metadata) {
                    ...
                    var PACKAGE_NAME = "waflash.data";
                    var REMOTE_PACKAGE_BASE = "waflash.data";
                    ...
                    function runWithFS() {
                        ...
                        function processPackageData(arrayBuffer) {
                            ...
                            Module["removeRunDependency"]("datafile_waflash.data")
                        }
                        Module["addRunDependency"]("datafile_waflash.data");
                ...
                loadPackage({
                    ...
                    "package_uuid": "1302f8fa-6355-4df6-ae92-6f55ca742376"
                })
            })();
            var moduleOverrides = {};
            var key;
            ...
            var STACK_BASE = 6130032,
                DYNAMIC_BASE = 6130032,
                DYNAMICTOP_PTR = 886976;
            ...
            var wasmBinaryFile = "waflash.wasm";
            ...
            var ASM_CONSTS = {
                1401: function($0) {
                    const sodir = UTF8ToString($0);
                    FS.mkdir(sodir);
                    FS.mount(IDBFS, {}, sodir);
                    FS.syncfs(true, err => {})
                },
                1523: function() {
                    FS.syncfs(err => {
                ...
                2028: function() {
                    ...
                    const mode = urlParams.get("v");
                    return mode == "1"
                },
                2163: function($0) {
                    const page_path = "/user/swf/" + UTF8ToString($0);
                    window.gtag && window.gtag("config", "UA-168755014-1", {
                        page_path: page_path
                    })
                },
                2412: function() {
                    ...
                    if (src) {
                        ...
                        if (src.startsWith("http")) {
                            ...
                            url = window.location.origin + window.location.pathname.substr(0, window.location.pathname.lastIndexOf("/") + 1) + src
                        }
            ...
            function changeCursor(type) {
                ...
                if (c) c.style.cursor = UTF8ToString(type)
            }

            function getCanvasPaddingLeft() {
                return Module["canvas"].style.paddingLeft
            }

            function getCanvasPaddingTop() {
                return Module["canvas"].style.paddingTop
            }

            function wafjs_hidestatus() {
                typeof Module.hideStatus == "function" && Module.hideStatus()
            }

            function wafjs_setcontentinfo(w, h, fps) {
                Module["canvas"].setAttribute("waf-content-width", w);
                Module["canvas"].setAttribute("waf-content-height", h);
                Module["canvas"].setAttribute("waf-content-fps", fps)
            }

            function wafjs_setstatus(msg) {
                typeof Module.setStatus == "function" && Module.setStatus(UTF8ToString(msg))
            }

            function wafjs_url_transformRequestUrl(purl) {
                const url = UTF8ToString(purl);
                const waf = Module["WAFLASH"];
                const ret = !waf ? url : waf.hal && waf.hal.url_transformRequestUrl(url);
                if (ret) {
                    const len = lengthBytesUTF8(ret) + 1;
                    const buf = _malloc(len);
                    stringToUTF8(ret, buf, len);
                    return buf
                }
                return 0
            }
            ...
            function _alGenSources(count, pSourceIds) {
                ...
                for (var i = 0; i < count; ++i) {
                    ...
                    if (window.proc_gain) proc_gain(gain);
                    var src = {
            ...
            var ___tm_timezone = (stringToUTF8("GMT", 887040, 4), 887040);
            ...
            var asmLibraryArg = {
                ...
                "fd_seek": _fd_seek,
                "fd_write": _fd_write,
                "getCanvasPaddingLeft": getCanvasPaddingLeft,
                "getCanvasPaddingTop": getCanvasPaddingTop,
                ...
                "time": _time,
                "usleep": _usleep,
                "wafjs_hidestatus": wafjs_hidestatus,
                "wafjs_setcontentinfo": wafjs_setcontentinfo,
                "wafjs_setstatus": wafjs_setstatus,
                "wafjs_url_transformRequestUrl": wafjs_url_transformRequestUrl
            };
            var asm = createWasm();
            Module["asm"] = asm;
            ...
            var _reopenBuffer = Module["_reopenBuffer"] = function() {
                return (_reopenBuffer = Module["_reopenBuffer"] = Module["asm"]["reopenBuffer"]).apply(null, arguments)
            };
            var _invokeExternalCallback = Module["_invokeExternalCallback"] = function() {
                return (_invokeExternalCallback = Module["_invokeExternalCallback"] = Module["asm"]["invokeExternalCallback"]).apply(null, arguments)
            };
            var ___em_js__wafjs_setstatus = Module["___em_js__wafjs_setstatus"] = function() {
                return (___em_js__wafjs_setstatus = Module["___em_js__wafjs_setstatus"] = Module["asm"]["__em_js__wafjs_setstatus"]).apply(null, arguments)
            };
            var ___em_js__wafjs_hidestatus = Module["___em_js__wafjs_hidestatus"] = function() {
                return (___em_js__wafjs_hidestatus = Module["___em_js__wafjs_hidestatus"] = Module["asm"]["__em_js__wafjs_hidestatus"]).apply(null, arguments)
            };
            var ___em_js__wafjs_setcontentinfo = Module["___em_js__wafjs_setcontentinfo"] = function() {
                return (___em_js__wafjs_setcontentinfo = Module["___em_js__wafjs_setcontentinfo"] = Module["asm"]["__em_js__wafjs_setcontentinfo"]).apply(null, arguments)
            };
            var ___em_js__getCanvasPaddingLeft = Module["___em_js__getCanvasPaddingLeft"] = function() {
                return (___em_js__getCanvasPaddingLeft = Module["___em_js__getCanvasPaddingLeft"] = Module["asm"]["__em_js__getCanvasPaddingLeft"]).apply(null, arguments)
            };
            var ___em_js__getCanvasPaddingTop = Module["___em_js__getCanvasPaddingTop"] = function() {
                return (___em_js__getCanvasPaddingTop = Module["___em_js__getCanvasPaddingTop"] = Module["asm"]["__em_js__getCanvasPaddingTop"]).apply(null, arguments)
            };
            ...
            var ___em_js__wafjs_url_transformRequestUrl = Module["___em_js__wafjs_url_transformRequestUrl"] = function() {
                return (___em_js__wafjs_url_transformRequestUrl = Module["___em_js__wafjs_url_transformRequestUrl"] = Module["asm"]["__em_js__wafjs_url_transformRequestUrl"]).apply(null, arguments)
            };
            var _strstr = Module["_strstr"] = function() {
                return (_strstr = Module["_strstr"] = Module["asm"]["strstr"]).apply(null, arguments)
            };
            var ___em_js__changeCursor = Module["___em_js__changeCursor"] = function() {
                return (___em_js__changeCursor = Module["___em_js__changeCursor"] = Module["asm"]["__em_js__changeCursor"]).apply(null, arguments)
            };
